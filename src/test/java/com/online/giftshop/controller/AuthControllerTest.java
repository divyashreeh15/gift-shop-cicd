 ...
 * @create date 2021-01-14 18:13:01
 * @modify date 2021-01-14 18:13:01
 * @desc [description]
 */
...
public class AuthControllerTest {
  ...
  void login() throws Exception {
    ...
    loginRequest.setUsername("Divya");
    mockMvc
  ...
  void loginInvalid() throws Exception {
    ...
    loginRequest.setPassword("123456");
    loginRequest.setUsername("dIV");
    mockMvc.perform(MockMvcRequestBuilders.post("/auth/login").contentType(MediaType.APPLICATION_JSON)
        .content(mapper.writeValueAsString(loginRequest))).andExpect(status().is4xxClientError());
  }
  ...
  void forgotPasswordInvalidUsername() throws Exception {
    mockMvc.perform(MockMvcRequestBuilders.get("/auth/forgotpassword/gaga").contentType(MediaType.APPLICATION_JSON))
